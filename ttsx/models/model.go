...
func init(){
	...
	//注册表
	orm.RegisterModel(new(User),new(Goods),new(GoodsType),new(GoodsSKU),new(GoodsImage),new(IndexGoodsBanner),new(IndexPromotionBanner),new(IndexTypeGoodsBanner),new(Receiver))
	//跑起来
